...
| Field | Value |
| --- | --- |
| Task-suite version | 1.0.6 (PATCH: `tool_call_gap_bare_unwired` records the bare-spelling evidence the 1.0.5 resolution rule discards; see the changelog below) |
| Date | 2026-08-20 |
